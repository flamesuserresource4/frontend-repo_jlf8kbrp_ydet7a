  ...
  return (
    <section id="about" className="relative w-full bg-gradient-to-b from-black via-[#07070b] to-black py-28 text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-24 bottom-10 h-56 w-56 rounded-full bg-fuchsia-500/10 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          <h2 className="bg-gradient-to-r from-cyan-300 via-white to-fuchsia-300 bg-clip-text text-3xl font-semibold text-transparent sm:text-4xl">
            Creativity x AI
          </h2>
          <p className="mt-5 text-white/80">
            We design immersive interfaces where machine intelligence feels intuitive and
            human. From 3D WebGL visuals to reactive voice and language systems, our
            products tell stories that move.
          </p>
        </motion.div>

        {/* Timeline-like micro storytelling */}
          ...
          {["Discover", "Design", "Deploy"].map((stage, i) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" style={{
                background: 'radial-gradient(600px circle at 0% 0%, rgba(34,211,238,0.08), transparent 40%), radial-gradient(600px circle at 100% 100%, rgba(217,70,239,0.08), transparent 40%)'
              }} />
